const OUTBOUND_DELIVERY = {
  OUTBOUND_DELIVERY: [
    ...
    {
      OUTBOUND_DEL_ID: "OUT003",
      OUTBOUND_DEL_SHIPPED_DATE: "2024-08-18",
      OUTBOUND_DEL_DATE_CUST_RCVD: "2024-08-25",
      OUTBOUND_DEL_STATUS: "Pending",
      OUTBOUND_DEL_DLVRY_OPT: "Express",
      OUTBOUND_DEL_DLVRY_QTY: 20,
      OUTBOUND_DEL_CITY: "Paris",
      OUTBOUND_DEL_PROVINCE: "France",
      OUTBOUND_DEL_DATECREATED: "2024-08-11",
      OUTBOUND_DEL_DATEUPDATED: "2024-08-15",
      OUTBOUND_DEL_CREATED_USER_ID: "USR003",
      SALES_ORDER_ID: "SO002",
      CUSTOMER_ID: "CUST002",
      CUSTOMER_NAME: "John Doe",
      CUSTOMER_CITY: "Paris",
      CUSTOMER_PROVINCE: "France",
      CUSTOMER_PHONENUM: "1234567890",
      CUSTOMER_EMAIL: "jamesboroy@example.com",
    },
  ],
